...
+ Submitting a [bug](https://github.com/CrowdStrike/logscale-gcp-components/issues)
+ Submitting a [pull request](https://github.com/CrowdStrike/logscale-gcp-components/pulls) to potentially resolve the issue
...
## Comments
If you have suggestions on how this process could be improved, please let us know by [creating an issue](https://github.com/CrowdStrike/logscale-gcp-components/issues).